...
type VesselRpk struct {
	...
	// Relations
	Ops []VesselRpkOp `gorm:"foreignKey:VesselRpkID" json:"ops"`
...
type VesselRpkOp struct {
	...
	StartActivityDate *time.Time          `gorm:"column:start_activity_date" json:"start_activity_date"`
	EndActivityDate   *time.Time          `gorm:"column:end_activity_date" json:"end_activity_date"`
