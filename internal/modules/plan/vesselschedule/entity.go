...
type VesselSchedule struct {
	...
	PPKNumber              *string    `gorm:"column:ppk_number;size:100" json:"ppk_number"`
	...
	CodeInaportnet         *string    `gorm:"column:code_inaportnet;size:100" json:"code_inaportnet"`
	LocationNameInaportnet *string    `gorm:"column:location_name_inaportnet;size:100" json:"location_name_inaportnet"`
	StartBerthPosition     *string    `gorm:"column:start_berth_position;size:100" json:"start_berth_position"`
	EndBerthPosition       *string    `gorm:"column:end_berth_position;size:100" json:"end_berth_position"`
